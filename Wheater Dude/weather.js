const getWeatherHere = function() {
    if(navigator.geolocation) {
        ...
        document.getElementById('result').innerHTML = "<h3>Sorry. Geolocation is not supported. Please enter your zip</h3>";
    }
}
...
const displayForecast = function(data) {
    ...
    output += "<p>Temperature: " + kToF(weather.temp).toFixed(1) + "C";
    output += "<br />Humidity: " + weather.humidity + "%";
    output += "<br />Today's High: " + kToF(weather.temp_max).toFixed(1) + "C";
    output += "<br />Today's Low: " + kToF(weather.temp_min).toFixed(1) + "C";
...
const kToF = (ktemp) => { return ktemp - 273.15};
